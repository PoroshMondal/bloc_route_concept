...
class GeneratedThirdScreen extends StatefulWidget {
  const GeneratedThirdScreen({
    super.key,
    this.title = "",
  ...
  State<StatefulWidget> createState() {
    return _GeneratedThirdScreen(appTitle: this.title);
  }
}

class _GeneratedThirdScreen extends State<GeneratedThirdScreen> {
  final String appTitle;
  _GeneratedThirdScreen({required this.appTitle});
