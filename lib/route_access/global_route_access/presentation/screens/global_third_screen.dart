...
class GlobalThirdScreen extends StatefulWidget {
  const GlobalThirdScreen({
    super.key,
    this.title = "",
  ...
  State<StatefulWidget> createState() {
    return _GlobalThirdScreen(appTitle: this.title);
  }
}

class _GlobalThirdScreen extends State<GlobalThirdScreen> {
  final String appTitle;
  _GlobalThirdScreen({required this.appTitle});
