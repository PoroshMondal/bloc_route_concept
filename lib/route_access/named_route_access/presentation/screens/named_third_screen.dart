...
class NamedThirdScreen extends StatefulWidget {
  const NamedThirdScreen({
    super.key,
    this.title = "",
  ...
  State<StatefulWidget> createState() {
    return _NamedThirdScreen(appTitle: this.title);
  }
}

class _NamedThirdScreen extends State<NamedThirdScreen> {
  final String appTitle;
  _NamedThirdScreen({required this.appTitle});
