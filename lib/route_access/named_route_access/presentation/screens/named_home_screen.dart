...
class NamedHomeScreen extends StatefulWidget {
  const NamedHomeScreen({
    super.key,
    this.title = "",
  ...
  Widget build(BuildContext context) {
    return BlocProvider<NamedCounterCubit>(
      create: (context) => NamedCounterCubit(),
  ...
  State<StatefulWidget> createState() {
    return _NamedHomeScreen(appTitle: this.title);
  }
}

class _NamedHomeScreen extends State<NamedHomeScreen> {
  final String appTitle;
  _NamedHomeScreen({required this.appTitle});
